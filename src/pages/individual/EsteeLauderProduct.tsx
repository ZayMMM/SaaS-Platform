...
interface EsteeLauderProductProps {
  productList: {
    id: number;
    product: string;
    brand: string;
...
const EsteeLauderProduct = ({
  productList,
  selectedDate,
  onDateChange,
  showYearPicker = false,
  showExport = false,
}: EsteeLauderProductProps) => {
  return (
    <>
      <Card className="dashboard-card h-100">
        <Card.Body>
          <div className="d-flex align-items-center justify-content-between w-100 flex-wrap">
            <h4 className="header-title fw-600">Estee Lauder Product</h4>
...
export default EsteeLauderProduct;
